...
urlpatterns = [
    ...
    path('clusters/add/', views.AWSClusterWizardView.as_view(), name='cluster_add'),
    path('clusters/<int:pk>/delete/', views.AWSClusterDeleteView.as_view(), name='cluster_delete'),
    path('clusters/<int:pk>/provision', views.AWSClusterProvisionView.as_view(), name='cluster_provision'),
]
